        ...
        <section class="login-section">
            <article class="translation-conatiner">
                ...
                <div class="container">
                    <div class="translation-btns">
                        ...
                        <button id="translate-espanol" class="translation espanol" title = "Espanol">esp</button>
                        ...
                        <button id="translate-chinesse" class="translation chinesse" title = "Chinesse">chi</button>
                    </div>
                </div>
            </article>
            <article class="form-login-article">
                <form action="login.php" id="login-form" method="POST">
                    ...
                    ?>
                    <h1 id="form-login-title" class="form-title">Login Details</h1>
                    <div class="input-container input-container__username">
                        <label for="user__name">
                            <i class="far fa-user"></i>
                            <p id="label-username-text">Email</p>
                        </label>
                        <input type="text" id="user__name" autofocus  autocomplete="username" name="email">
                    </div>
                    <div class="input-container input-container__password">
                        <label for="user__password">
                            <i class="fas fa-lock"></i>
                            <p id="label-password-text">Password</p>                            
                        </label>
                        <input type="password" id="user__password"  autocomplete="current-password" name="password">
                    </div>
                    <input id="loginBtn" type="submit" value="login" name="submit">
                    <div class="form-extra-function">
                        <p href="" class="signup" role="button" tabindex="-1">Don’t have an account yet?</p>
